...
export default function LoginPage() {
  ...
  const handleDemoSignIn = async () => {
    setEmail("admin@gridguard.io");
    setPassword("password123");
    setIsLoading(true);
    setError("");
    try {
      await loginUser("admin@gridguard.io", "password123");
      navigate("/dashboard");
    } catch (err: unknown) {
        ...
        <div className="relative hidden overflow-hidden lg:flex">
          ...
          <div className="relative z-10 flex w-full flex-col justify-center px-16 xl:px-24">
            ...
            <div className="mb-10 flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold">Grid Guard</h1>
            ...
            <h2 className="max-w-xl text-5xl font-bold leading-tight xl:text-6xl">
              Protect your grid.
              <br />
              <span className="text-lime-400">Power your future.</span>
            </h2>

            <p className="mt-6 max-w-lg text-lg leading-8 text-slate-400">
              Monitor solar generation, grid conditions and energy performance
            ...
            <div className="mt-10 grid max-w-xl grid-cols-2 gap-4">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur">
                <Zap className="mb-3 text-lime-400" size={22} />
                <p className="text-2xl font-bold">45.2 kWh</p>
                <p className="mt-1 text-sm text-slate-500">Energy Generated</p>
              </div>

              <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur">
                <Activity className="mb-3 text-lime-400" size={22} />
                <p className="text-2xl font-bold">99.9%</p>
                <p className="mt-1 text-sm text-slate-500">System Reliability</p>
              </div>
            </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-10 flex items-center justify-center gap-3 lg:hidden">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-lime-400">
                <Sun className="text-slate-950" size={24} />
              </div>

              <div>
                <h1 className="text-xl font-bold">Grid Guard</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="group flex w-full items-center justify-center gap-2 rounded-xl bg-lime-400 py-3.5 font-semibold text-slate-950 transition hover:bg-lime-300 disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full rounded-xl border border-lime-400/20 bg-lime-400/5 py-3 text-sm font-medium text-lime-400 transition hover:bg-lime-400/10"
              >
                Quick Demo Sign In
              </button>
            </form>
